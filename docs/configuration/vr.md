...
sidebar_label: VR (experimental)
---

The player supports monoscopic (equirectangular) videos with 360-degree view, the original would look like this:

<div class="docs-player" data-instance="vr"></div>
